...
function Dashboard() {
    ...
    const handleSponserNameChange = (event) => {
        setSponserName(event.target.value);
      };
    ...
    formData.append('contractType', 'Sponser');
        ...
        <ChakraProvider theme={theme}>
            ...
            <SimpleGrid columns={6} spacing={0} p='10'>
                ...
                <GridItem colSpan="4">
                    ...
                    <Box p='0' align="center" style={{ fontSize: "30px", fontWeight: "800" }}>Sponsors</Box>
                </GridItem>
            </SimpleGrid>
                            ...
                            <Card maxW='lg' boxShadow={'2xl'}
                                ...
                                <CardBody p={10}>
                                    <Stack spacing={4}>
                                        ...
                                        <FormControl id="sponserName">
                                            <FormLabel>Sponsor Name</FormLabel>
                                            <Input type="text" value={sponserName} onChange={handleSponserNameChange}/>
                                        </FormControl>
